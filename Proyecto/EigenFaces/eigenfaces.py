# USAGE
# python eigenfaces.py --input C:\Proyecto\Data_Base\all --visualize 1

# input = C:\Proyecto\Data_Base\with_mask
#         C:\Proyecto\Data_Base\without_mask
# 		  C:\Proyecto\Data_Base\all
# 		  C:\Proyecto\Data_Base\all_augmented
...
(faces, labels) = load_face_dataset(args["input"], net,
	minConfidence=0.5, minSamples=1)
